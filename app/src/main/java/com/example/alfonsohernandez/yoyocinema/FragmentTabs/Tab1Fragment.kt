...
import com.example.alfonsohernandez.yoyocinema.POJOGoogle.Cinema
import com.example.alfonsohernandez.yoyocinema.POJOGoogle.MarkerGM
import com.example.alfonsohernandez.yoyocinema.POJOGoogle.Response
...
import com.example.alfonsohernandez.yoyocinema.rest.GoogleApiService
...
class Tab1Fragment : Fragment(), OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener, ConnectionCallbacks, GoogleMap.OnMarkerClickListener {
    ...
    */
    ...
    fun findNearbyPlaces(type: String, latLng: LatLng) {
        ...
        call.enqueue(object : Callback<com.example.alfonsohernandez.yoyocinema.POJOGoogle.Response> {
            override fun onFailure(call: Call<com.example.alfonsohernandez.yoyocinema.POJOGoogle.Response>?, t: Throwable?) {
