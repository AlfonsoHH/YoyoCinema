...
interface GoogleApi {
    ...
    fun getNearbyPlaces(@Query("type") type: String, @Query("location") location: String, @Query("radius") radius: Int): Call<com.example.alfonsohernandez.yoyocinema.POJOGoogle.Response>
