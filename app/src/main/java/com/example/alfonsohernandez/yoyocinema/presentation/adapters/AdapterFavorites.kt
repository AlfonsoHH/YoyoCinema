...
import com.example.alfonsohernandez.yoyocinema.domain.models.MovieFav
 ...
 */
class AdapterFavorites(val movieList: List<MovieFav?>?, val activity: Activity): RecyclerView.Adapter<AdapterFavorites.ViewHolder>() {
    ...
    class ViewHolder(itemView: View, val activity: Activity): RecyclerView.ViewHolder(itemView){
        ...
        fun bindItems(movie: MovieFav?){
            ...
            itemView.setOnClickListener({
                ...
                val moviConversion = MovieResultsItem(movie?.overview, null, null, null, movie?.title, null, movie?.posterPath, null, movie?.releaseDate, movie?.voteAverage, null, null, null, null)
